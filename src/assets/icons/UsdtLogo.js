...
export default function UsdtLogo(width = 20, height = 20) {
    return (
        <svg id="Layer_1" dataname="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 339.43 295.27" height={height} width={width}>
            <path
