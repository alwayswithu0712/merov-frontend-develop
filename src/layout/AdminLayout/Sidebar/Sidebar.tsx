...
export default function Sidebar(props: { isShow: boolean; isShowMd: boolean }) {
  ...
  return (
    <div
      ...
      id="sidebar"
    >
      <div className="sidebar-brand-pool d-none d-md-flex align-items-center justify-content-center">
        {/* <svg
      ...
      <div className="sidebar-nav-pool flex-fill">
        <SidebarNav />
      </div>
...
export const SidebarOverlay = (props: { isShowSidebar: boolean; toggleSidebar: () => void }) => {
  ...
  return (
    <div
      tabIndex={-1}
      aria-hidden
      className={classNames('sidebar-overlay-pool position-fixed top-0 bg-dark w-100 h-100 opacity-50', {
