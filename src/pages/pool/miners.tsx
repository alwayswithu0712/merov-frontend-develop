  ...
  <AdminLayout>
    <div className="row mt-5 mb-5">
      <div className="col-sm-12 col-lg-4 ">
        <Card bg="secondary" text="white" className="mb-4 card-pool" style={{ height: "100%" }}>
      ...
      <div className="col-sm-12 col-lg-8">
        <Card className=" bg-secondary content card-pool">
          <Card.Body>
    ...
    <div className="row justify-content-between">
      <div className="col-lg-6 col-md-12 p-2">
        <Card className="card bg-secondary card-pool">
