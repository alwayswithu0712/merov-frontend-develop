...
const Page: NextPageWithLayout = () => <Account view="addresses" />;
...
export const getServerSideProps: GetServerSideProps = withPagePermissionsRequired([Permission.Addresses]);
